            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('admin/product2s/create') }}"><button class="button2">Add Product</button></a>
                    </div>
                    <br>
                <div class="d-flex align-items-center   justify-content-between">
                    
                    <form action="/product2s/search" class="form-inline" method="GET">
                        <div class="group">
                    ...
                    <a href="{{ route('admin/print-product2') }}" target="_blank"><button class="button2"><i class="fa fa-print"></i></button></a>
                </div>
                <br>
                    <hr/>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @forelse ($product2s as $product2)
                            <tr>
                                <th class="align-middle">{{ $loop->iteration }}</th>
                                <td class="align-middle">{{ $product2->type }}</td>
                                <td class="align-middle">{!! DNS2D::getBarcodeHTML("$product2->serial_number", 'QRCODE',5,5) !!}
                                  
                                </td>
                                <td class="align-middle">{{ $product2->description }}</td>
                                <td class="align-middle">
                                    <div class="btn btn-group" role="group aria-label="Basic example">
                                        <a href="{{ route('admin/product2s/edit', ['id'=>$product2->id]) }}"><button class="button3">Edit</button></a>
                                        <a href="{{ route('admin/product2s/delete', ['id'=>$product2->id]) }}"><button class="button4">Delete</button></a>
                                    </div>
                                </td>
                            </tr>
                            @empty
