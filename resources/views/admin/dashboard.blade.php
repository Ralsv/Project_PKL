    ...
    <body class="bg-gray-100">
     <div class="container mx-auto p-6">
      <div class="flex items-center bg-white rounded-lg shadow-lg overflow-hidden">
       <div class="w-1/2">
        <img alt="" class="w-full h-full object-cover" height="400" src="https://storage.googleapis.com/a1aa/image/v46MJzVNXNIuBdSb2EM3hgVQSWlHfQfunNeykt03kNQ705qnA.jpg" width="600"/>
       </div>
       <div class="w-1/2 p-8">
        <h1 class="text1 text-6xl font-bold text-red-600">
         Welcome To
        </h1>
        ...
        <p><a href="products"><button class="button2 mt-4 px-4 py-2">Products</button></a></p>
       </div>
      </div>
     </div>
    </body>
